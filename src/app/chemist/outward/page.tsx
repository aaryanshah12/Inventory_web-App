        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          {hasBatch && (
            <div className="flex flex-col gap-1">
              ...
              <input className="input-field input-dark chemist-focus" type="number" value={form.no_of_bags ?? 0} onChange={e => setForm(f => ({ ...f, no_of_bags: parseNumber(e.target.value) }))} />
            </div>
          )}
          ...
          {hasBags && (
            <div className="flex flex-col gap-1">
              ...
              <input className="input-field input-dark chemist-focus" type="number" step="0.01" value={form.as_is ?? 0} onChange={e => setForm(f => ({ ...f, as_is: parseNumber(e.target.value) }))} />
            </div>
          )}
          ...
          {hasAsIs && (
            <div className="flex flex-col gap-1">
              ...
              <input className="input-field input-dark chemist-focus" type="number" step="0.01" value={form.purity ?? 0} onChange={e => setForm(f => ({ ...f, purity: parseNumber(e.target.value) }))} />
            </div>
          )}
