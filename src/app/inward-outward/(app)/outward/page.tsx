...
import { fetchOutwards, saveOutward, deleteOutward, fetchCompanies, fetchProducts, fmtDate, today, exportCSV } from '@/lib/io/api'
    ...
    <div className="p-4 lg:p-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button onClick={() => exportCSV(filtered.map(r => ({ 'Outward No': r.outward_number, Date: r.outward_date, Supplier: r.supplier?.company_name ?? '' })), 'outward.csv')} className="btn btn-ghost"><Download size={14}/> Export</button>
